...
export default class GameModal extends HTMLElement {
    ...
    setCategories() {
        ...
        this.categories.forEach(category => {
            categoryContainer.innerHTML += ` <div class="category">
                ...
                <Input class="cate" id="input-${category}" value=${this.letters[this.actualRound]}></Input>
              </div>`;
        });
    }

    setUsers() {
        let playersContainer = this.shadowRoot.getElementById("playersContainer") || this.shadowRoot.querySelector(".players")
    ...
    showLetter() {
        let letterContainer = this.shadowRoot.getElementById("timer");
    ...
    sendValues() {
        ...
        this.categories.forEach(category => {
            ...
            if (input.value != "" && input.value != this.letters[this.actualRound]) {
